...
const liquidbuttonVariants = cva(
  "inline-flex items-center transition-colors justify-center cursor-pointer gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-[color,box-shadow] disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] aria-invalid:ring-destructive/20 dark:aria-invalid:ring-destructive/40 aria-invalid:border-destructive",
  {
    variants: {
      variant: {
        default:
          "bg-transparent text-[#d8ff9b] hover:text-[#edffca] hover:scale-[1.02] duration-300 transition",
        destructive:
...
function LiquidButton({
  ...
  return (
    <>
      ...
      >
        <div
          className="absolute top-0 left-0 z-0 h-full w-full rounded-full border border-[#c1ff72]/35 bg-[rgba(193,255,114,0.06)]
        shadow-[0_0_12px_rgba(193,255,114,0.16),inset_0_1px_0_rgba(255,255,255,0.18)]
        transition-all duration-300 group-hover:border-[#c1ff72]/55 group-hover:shadow-[0_0_18px_rgba(193,255,114,0.24),inset_0_1px_0_rgba(255,255,255,0.24)]"
        />
        <div
        ...
        <div className="pointer-events-none z-10 flex items-center gap-2.5">{children}</div>
        <GlassFilter />
      </Comp>
    </>
  );
